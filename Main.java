...
// самый длинный по исполнению получается вариант 1 с тремя циклами без компаратора.
// Потом вариант 3, где хранение т/ф книги организовано HashMap<String, String>, вероятно, из-за сортировки строк по их длине.
